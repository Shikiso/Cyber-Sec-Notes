...
# Types
There a multiple types of logs which making finding specific logs easier.
...
- **Application:** There are many applications running on the operating system
- **System:** The operating system itself has different running operations
