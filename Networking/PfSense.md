...
5. Press **Add new Certificate**. (This is to create the server certificate).
6. Then fill in the Descriptive Name and Common Name and press **Create new Certificate**
![](/Images/pfsense_7.png)
7. Now you need to setup the OpenVPN Server
8. Set the following settings (pictures below for reference):
	...
	6. You can set Redirect IPv4 Gateway to force all traffic generated by the remote device through the VPN. Will make your server work harder.
...
9. Add both Firewall rules and press **Next** then **Finish**
